...
<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white texto-azul " id="navbar1" >
  <!--div class=" "><a class="mx-auto navbar-brand fuente-institucional texto-azul f-size-18 hover-amarillo" data-toggle="tooltip" data-placement="auto" title="Ir al inicio" href="index"><i class="fa fa-home"></i></a></div-->
  ...
  <div class="collapse navbar-collapse f-size-12 " id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto ml-md-0 ml-sm-0 ml-0 ml-0  ">
      <li class="nav-item active pt-2 pb-2 hover-amarillo ">
        <a class="nav-link texto-azul pl-md-2 pl-sm-2 border-left border-right borde-amarillo" href="inscripciones">Admisiones <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item pt-2 pb-2 hover-amarillo ">
        <a class="nav-link texto-azul pl-md-2 pl-sm-2 border-right borde-amarillo" href="convocatorias">Convocatorias</a>
      </li>
