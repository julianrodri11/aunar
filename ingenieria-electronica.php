		...
		<div class="container-fluid ">
			...
			<div class="row d-flex justify-content-center mt-5">
				<div class="col-12 col-lg-8">
					<div id="accordion">
					    <div class="card ">					    	
					      <div class="card-header fondo-azul  p-0 pl-3">
					    ...
					    <div class="card">
					      <div class="card-header fondo-azul">
					        <a class="collapsed card-link pt-sans text-white" data-toggle="collapse" href="#collapseThree">
					          Fredy Armando Romero
					        </a>
					      </div>
