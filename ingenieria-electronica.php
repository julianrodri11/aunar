...
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<img class="mx-auto img-fluid" width="100%" src="img/ingenieria-electronica-aunar.jpg" alt="ingeniería electrónica autónoma de nariño" />
				</div>
			</div>
		</div>
		<div class="container-fluid">
		...
		<div class="container-fluid">
			<div class="row p-4 m-1 bg-secondary">
		...
		<div class="container-fluid">
			<div class="row p-4 m-1 bg-secondary">
				<div class="col-6 bg-dark">
					...
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Director del departamento técnico en empresas del sector público y privado.<br>
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Empresario independiente en la producción de circuitos electrónicos.<br>
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Ingeniero de montaje y mantenimiento de sistemas electrónicos y de redes de comunicación.<br>
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Diseñador o interventor de proyectos tecnológicos.<br>		
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Consultor de empresas relacionadas con la electrónica.<br>		
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Director de mantenimiento preventivo y correctivo de equipos electrónicos.<br>
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Diseñador de soluciones en automatización de procesos industriales.<br>
					<i class="fa fa-angle-right texto-amarillo f-size-14"></i> Director y/o participante en proyectos de investigación tecnológica.<br>
					</div>
				</div>
				<div class="col-6 bg-success">
		...
		<div class="container-fluid">
			<div class="row p-4 m-1 bg-secondary">Minima rerum, nulla!</div>
		</div>
		<div class="container-fluid">
