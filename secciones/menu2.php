                ...
                <div class="collapse navbar-collapse fuente-institucional d-flex justify-content-center " id="navbarNavDropdown_principal">
                    <ul class="navbar-nav  ml-md-0 ml-sm-0 ml-0 ml-0 mx-lg-auto animated zoomInDown ">
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os px-lg-3  hvr-underline-from-center" href="#" id="navbarDropdownMenu_est" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                institucional
                            </a>
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os px-lg-3  hvr-underline-from-center" href="#" id="navbarDropdownMenu_doc" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Investigación
                            </a>
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os px-lg-3  hvr-underline-from-center" href="#" id="navbarDropdownMenu_ext" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Bienestar
                            </a>
