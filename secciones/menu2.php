                ...
                <div class="collapse navbar-collapse fuente-institucional d-flex justify-content-center " id="navbarNavDropdown_principal">
                    <ul class="navbar-nav  ml-md-0 ml-sm-0 ml-0 ml-0 mx-lg-auto animated zoomInDown ">
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os pl-5 px-lg-1  hvr-underline-from-center" href="#" id="navbarDropdownMenu_est" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                institucional
                            </a>
                            <ul class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdownMenu_est">
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os pl-5 px-lg-1  hvr-underline-from-center" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Oferta Académica
                            </a>
                            <ul class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item texto-azul-os hvr-underline-from-left dropdown-toggle" href="#">Ingeniería</a>
                                    <ul class="dropdown-menu text-center text-lg-left fondo-gris-os">
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="ingenieria-electronica" class="sin-texto-subrayado texto-azul-os">Ingeniería Electrónica</a></li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="ingenieria-mecanica" class="sin-texto-subrayado texto-azul-os">Ingeniería Mecánica</a></li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="ingenieria-informatica" class="sin-texto-subrayado texto-azul-os">Ingeniería Informática</a></li>
                                ...
                                <li><a class="dropdown-item texto-azul-os hvr-underline-from-left dropdown-toggle" href="#">Ciencias administrativas y contables</a>
                                    <ul class="dropdown-menu text-center text-lg-left fondo-gris-os">                                        
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="administracion-empresas" class="sin-texto-subrayado texto-azul-os">Administración de Empresas</a> </li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="administracion-empresas-a-distancia" class="sin-texto-subrayado texto-azul-os">Administración de Empresas a Distancia</a> </li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="contaduria-publica" class="sin-texto-subrayado texto-azul-os">Contaduría Pública</a> </li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="contaduria-publica-a-distancia" class="sin-texto-subrayado texto-azul-os">Contaduría Pública a Distancia</a> </li>
                                    </ul>
                                </li>

                                <li><a class="dropdown-item texto-azul-os hvr-underline-from-left dropdown-toggle" href="#">Bellas artes</a>
                                    <ul class="dropdown-menu text-center text-lg-left fondo-gris-os">
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="diseno-de-modas" class="sin-texto-subrayado texto-azul-os">Técnico Laboral por Competencias <br> en Diseño y Confección de Modas</a></li>
                                    </ul>
                                </li>

                                <li><a class="dropdown-item texto-azul-os hvr-underline-from-left dropdown-toggle" href="#">Ciencias de la salud</a>
                                    <ul class="dropdown-menu text-center text-lg-left fondo-gris-os">                                        
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="mecanica-dental" class="sin-texto-subrayado texto-azul-os">Tecnología en Mecánica Dental <strong>(No ofertado)</strong></a></li>
                                    </ul>
                                </li>

                                <li><a class="dropdown-item texto-azul-os hvr-underline-from-left dropdown-toggle" href="#">Facultad de ciencias agropecuarias</a>
                                    <ul class="dropdown-menu text-center text-lg-left fondo-gris-os">
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="mercadeo-agropecuario" class="sin-texto-subrayado texto-azul-os">Tecnología en Mercadeo <br> Agropecuario</a></li>
                                        <li><a class="dropdown-item texto-azul-os hvr-underline-from-left" href="plantas-aromaticas" class="sin-texto-subrayado texto-azul-os">Tecnología en Transformación <br> de Plantas Aromáticas</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os pl-5 px-lg-1  hvr-underline-from-center" href="#" id="navbarDropdownMenu_doc" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Investigación
                            </a>
                            <ul class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdownMenu_doc">
                        ...
                        <li class="nav-item dropdown py-0 border-right borde-azul text-center">
                            <a class="nav-link dropdown-toggle texto-azul-os pl-5 px-lg-1  hvr-underline-from-center" href="#" id="navbarDropdownMenu_ext" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Bienestar
                            </a>
                            <ul class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdownMenu_ext">
                        ...
                        <li class="nav-item active  py-0 border-right borde-azul text-center">                            
                            <a class=" nav-link texto-azul-os pl-5 px-lg-1  hvr-underline-from-center pointer " href="virtual">Aunar Virtual<span class="sr-only">(current)</span></a>
                        </li>
