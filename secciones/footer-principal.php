    ...
    <div class="container py-1 ">
      <div class="row d-flex justify-content-between">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-2 text-center text-sm-left">
          ...
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="f2" href="docs/footer/Reglamento_Administrativos.pdf">
              Reglamento Administrativos
            </a>
          </div>
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="f3" href="docs/footer/Reglamento_Docentes.pdf">
              Reglamento Docentes
            </a>
          </div>
          <div class="mb-1 text-light fuente-institucional small">
          ...
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="fg" href="docs/trabajos_de_grado/reglamentos-trabajo-grado.pdf">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 py-2 text-center text-sm-left text-md-center">
          ...
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="f7" href="docs/footer/PLAN_DESARROLLO_2013_2023.pdf">
          ...
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="f9" href="docs/footer/Plan_Educactivo_Institucional.pdf">
              Plan Educativo Institucional
            </a>
          </div>
          <div class="mb-1 text-light fuente-institucional small">
            <a class="text-white" data-toggle="tooltip" data-placement="auto" title="Ver" target="f11" href="docs/footer/Estatuto_Bienestar.pdf">
              Estatuto Bienestar
            </a>
          </div>
          <div class="mb-1 text-light fuente-institucional small">
    ...
    <div class="row p-3 ">
      <div class="col-lg-6 col-sm-12 mt-3  text-light d-flex justify-content-center align-items-center justify-content-lg-end ">
        <div class="col-12 col-md-6 col-sm-6">
          <img class="img-fluid" width="100%" src="img/aunar-logo-antiguo.svg" alt="Logo AUNAR Autónoma de Nariño">
        </div>
      </div>
        ...
        <div class="">
          <div>
            <a href="https://goo.gl/CkZ9AW" target="_google_maps_aunar" class="hvr-icon-pulse">
              <img src="img/ubicacion-aunar.png" width="8px" alt="ubicación aunar">
