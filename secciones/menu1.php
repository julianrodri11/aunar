...
<div class="row m-0 p-0">
                ...
                <ul class="navbar-nav mr-auto ml-md-0 ml-sm-0 ml-0 ml-0">
                        ...
                        <ul class="dropdown-menu f-size-12" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center dropdown-toggle"
                                ...
                                <ul class="dropdown-menu f-size-12">
                                    <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/CALENDARIO_ACADEMICO_2018_II.pdf"
                                            target="_blanck_1">Calendario Académico 2018-2</a></li>
                                    <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/CALENDARIO_ACADEMICO_2018_1.pdf"
                                            target="_blanck_2">Calendario Académico 2018-1</a></li>
                                    <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/CALENDARIO_ACADEMICO_2017_2.pdf"
                                            target="_blanck_3">Calendario Académico 2017-2</a></li>
                                    <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/CALENDARIO_ACADEMICO_2017_1.pdf"
                    ...
                    <li class="nav-item dropdown py-2">
                        ...
                        <ul class="dropdown-menu f-size-12" aria-labelledby="navbarDropdownMenu_est">
                            <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/reglamento_estudiantil.pdf"
                    ...
                    <li class="nav-item dropdown py-2">
                        ...
                        <ul class="dropdown-menu f-size-12" aria-labelledby="navbarDropdownMenu_doc">
                            <li><a class="dropdown-item f-negrita texto-azul hvr-underline-from-center" href="docs/reglamento_docentes.pdf"
    ...
    <div class="col-lg-5 p-0 m-0 pt-2">
        ...
        <div class="rectangulo-sesgado mb-0">
            ...
            <div class="row pt-2 ml-0  mr-2 d-flex justify-content-center">
