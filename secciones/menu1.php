...
<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white texto-azul bg-success f-negrita fuente-institucional" id="navbar1" >
  ...
  <div class="collapse navbar-collapse f-size-12 " id="navbarSupportedContent">
      ...
      <li class="nav-item pt-2 pb-2  dropdown">
        ...
        <div class="dropdown-menu f-size-12" aria-labelledby="admisiones">
          ...
          <li class="col-12 nav-item dropdown dropright ">
            <a class="nav-link dropdown-toggle texto-azul pl-md-2 pl-sm-2 hvr-underline-from-center f-negrita" href="google.com" id="calendarios" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >Calendarios </a>
            <div class="dropdown-menu dropdown-menu-right f-size-12" aria-labelledby="calendarios">
              <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="docs/cronograma_general2017_1.pdf" target="_blanck">Calendario Académico 2017-1</a>
              <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="docs/cronograma_general2017_2.pdf" target="_blanck">Calendario Académico 2017-2</a>
              <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="docs/cronograma_general2018_1.pdf" target="_blanck">Calendario Académico 2018-1</a>
              <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="docs/cronograma_general2018_1.pdf" target="_blanck">Calendario Académico 2018-2</a>
            </div>
          </li>
    ...
    <li class="nav-item pt-2 pb-2 dropdown  ">
      <a class=" nav-link dropdown-toggle texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="#" id="estudiantes" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Estudiantes</a>
      <div class="dropdown-menu f-size-12" aria-labelledby="estudiantes">
        ...
        <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="http://biblioteca.aunar.edu.co/" target="_blanck">Biblioteca</a>
...
<li class="nav-item pt-2 pb-2 dropdown  ">
  <a class=" nav-link dropdown-toggle texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="#" id="docentes" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Docentes</a>
...
<li class="nav-item pt-2 pb-2  ">
  <a class=" nav-link texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="convocatorias.php">Convocatorias</a>
</li>
<li class="nav-item pt-2 pb-2 dropdown  ">
  <!--a class="nav-link active texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="#">Extensiones</a-->
  <a class=" nav-link dropdown-toggle texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="#" id="extensiones" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Extensiones</a>
  <div class="dropdown-menu f-size-12" aria-labelledby="extensiones">
    ...
    <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="https://aunarcartagena.edu.co/"  target="_blanck">Cartagena</a>
    <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="#"  target="_blanck">Ipiales</a>
    <a class=" dropdown-item texto-azul f-negrita hvr-underline-from-center" href="#"  target="_blanck">Putumayo</a>
  </div>
</li>
<li class="nav-item pt-2 pb-2  ">
  <a class=" nav-link texto-azul pl-md-2 pl-sm-2 border-left borde-2 borde-azul hvr-underline-from-center" href="http://190.121.158.228/public/" target="_blanck">Graduados</a>
</li>
</ul>
