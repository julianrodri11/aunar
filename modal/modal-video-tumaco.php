...
<!-- The Modal -->
  <div class="modal fade" id="modalVideoTumaco">
        ...
        <div class="modal-body fondo-gris-c">
          ...
          <!-- ---------- -->
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/YQBAEXnuVpI?rel=0" allowfullscreen></iframe>
            </div>          
...
<script>
    $("#modalVideoTumaco").on('hidden.bs.modal', function (e) {
        $("#modalVideoTumaco iframe").attr("src", $("#modalVideoTumaco iframe").attr("src"));
    });
</script>   