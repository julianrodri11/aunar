  ...
  <div class="row"> 
    <div class="col-lg-2 col-sm-12 col-md-4 pt-sm-4  d-flex align-items-center justify-content-center">
      <div class="row ">
        <div class="col-12 ">
          <!-- <div class="row ">            
              <div class=" col-3 fondo-amarillo sombra-iconos icono-blanco text-center "><i class="fa fa-envelope" ></i></div>
              <div class=" col-7 fondo-azul text-white">Necesitas ayuda? Contáctanos</div>              
          </div> -->
        </div>        
      </div>
    </div>
...
<div class="container-fluid">
  <div class="row d-flex align-items-stretch pt-5">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center"><img class="img-fluid " src="img/noticia1.png" alt="Noticias Aunar" width="100%"></div>


    <!-- noticia 2 -->
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center"><img class="img-fluid " src="img/noticia2.png" alt="Noticias Aunar" width="100%"></div>
    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex align-items-center">
      <div class="text-center p-5  ">
