  ...
  <div class="row">
    <div class="col-12 col-lg-6 mt-3 d-flex justify-content-center align-items-center">
      <div class="row col-12 pl-lg-4 ">
        ...
        <div class="col-12  ">
          <a href="#" class="p-2 border borde-azul badge badge-pill hover-amarillo hover-texto-blanco float-right texto-azul sin-texto-subrayado">LEER MÁS</a>
        </div>
      </div>
    </div>
